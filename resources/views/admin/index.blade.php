        ...
        <article class="dash_login_left_box">
            ...
            <form name="login" action="{{ route('admin.login.do') }}" method="post" autocomplete="off">
                ...
                <label>
                    ...
                    <input type="email" name="email" placeholder="Informe seu e-mail" value="filipe.dbitt@gmail.com"/>
                </label>
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.upinside.com.br">www.<b>filipin</b>.com.br</a></p>
