                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="type_of_communion" class="select2">
                                            ...
                                            <option value="Separação Total de Bens">Separação Total de Bens
                                            </option>
                                ...
                                <div class="app_collapse_content">
                                    ...
                                    <div class="companies_list">
                                        ...
                                        <div class="companies_list_item mb-2">
                                            ...
                                            <p><b>Endereço:</b> Rodovia Dr. Antônio Luiz de Moura Gonzaga, 3339
                                                Bloco A
                                                Sala
                                                208</p>
                                    ...
                                    <p class="text-right">
                                        <a href="javascript:void(0)"
                                           class="btn btn-green btn-disabled icon-building-o">Cadastrar
                                            Nova Empresa</a>
                                    </p>
                                </div>
                            </div>
