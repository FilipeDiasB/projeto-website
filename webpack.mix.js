...
mix
    ...
    .copyDirectory('resources/views/admin/assets/js/select2', 'public/backend/assets/css/js/select2')
    .copyDirectory('resources/views/admin/assets/js/tinymce', 'public/backend/assets/css/js/tinymce')
